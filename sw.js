...
function injectOverlayResponse(blob, payload) {
  return blob.text().then(function (html) {
    ...
    var overlay = [
      ...
      'function isDismissed(){try{return sessionStorage.getItem(dismissKey)==="1";}catch(e){return false;}}',
      'function setDismissed(flag){try{if(flag){sessionStorage.setItem(dismissKey,"1");}else{sessionStorage.removeItem(dismissKey);}}catch(e){}}',
