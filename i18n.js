    ...
    es: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Índice de ayuda">'
          ...
          + '<p>Genera un enlace del visor para compartir y guarda una copia local para que el recurso se abra más rápido la próxima vez.</p>'
          + '</section>'
    ...
    ca: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Índex d’ajuda">'
          ...
          + '<p>Genera un enllaç del visor per compartir i desa una còpia local perquè el recurs s’obri més ràpid la propera vegada.</p>'
          + '</section>'
          + '<section aria-labelledby="help-como-se-usa">'
    ...
    gl: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Índice de axuda">'
          ...
          + '<p>Xera unha ligazón do visor para compartir e garda unha copia local para que o recurso se abra máis rápido a próxima vez.</p>'
          + '</section>'
          + '<section aria-labelledby="help-como-se-usa">'
    ...
    eu: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Laguntzaren aurkibidea">'
          ...
          + '<p>Partekatzeko bisorearen esteka sortzen du, eta kopia lokal bat gordetzen du hurrengoan azkarrago irekitzeko.</p>'
          + '</section>'
          + '<section aria-labelledby="help-como-se-usa">'
    ...
    en: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Help index">'
          ...
          + '<p>Generates a viewer link to share and stores a local copy so the resource opens faster next time.</p>'
          + '</section>'
          + '<section aria-labelledby="help-como-se-usa">'
    ...
    de: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Hilfe-Inhalt">'
          ...
          + '<p>Erzeugt einen Viewer-Link zum Teilen und speichert eine lokale Kopie, damit sich die Ressource beim nächsten Mal schneller öffnet.</p>'
          + '</section>'
          + '<section aria-labelledby="help-como-se-usa">'
