    ...
    es: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Índice de ayuda">'
          ...
          + '<li><a href="#help-actualizaciones">Actualizaciones</a></li>'
          ...
          + '<li>Elige una ruta: <strong>Crear un ZIP</strong> o <strong>Ya tengo un ZIP en la nube con enlace</strong>.</li>'
          ...
          + '</ol>'
          + '<h4 class="about-subtitle" id="help-ruta-tengo" tabindex="-1">Ruta: Ya tengo un ZIP en la nube con enlace</h4>'
          + '<ol class="about-steps">'
          + '<li>En <strong>Publicar</strong>, entra en <strong>Ya tengo un ZIP en la nube con enlace</strong>.</li>'
          ...
          + '<li><strong>QR</strong>: muestra un código QR del enlace (ideal para proyectar o imprimir).</li>'
          + '<li><strong>Insertar en web</strong>: muestra el código para incrustarlo (si está permitido).</li>'
          + '<li><strong>Actualizar</strong>: vuelve a descargar el ZIP y actualiza la copia local (si el recurso ha cambiado manteniendo el mismo enlace).</li>'
          ...
          + '</ul>'
          + '<p class="about-note">Nota: si borras los datos del navegador, usas otro dispositivo o un navegador distinto, estos desparecerán.</p>'
          + '</section>'
          + '<section aria-labelledby="help-actualizaciones">'
          + '<h3 class="about-section-title" id="help-actualizaciones" tabindex="-1">Actualizaciones</h3>'
          + '<p>El visor puede detectar cambios en un recurso cuando el archivo ZIP se sustituye en la nube <strong>manteniendo el mismo enlace</strong>. En la mayoría de servicios de almacenamiento basta con <strong>subir el nuevo ZIP reemplazando al anterior</strong>.</p>'
          + '<ul>'
          + '<li><strong>En la vista del alumno</strong>, si el recurso ha cambiado, aparece un aviso visible que permite <strong>actualizarlo en ese mismo momento</strong>.</li>'
    ...
    ca: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Índex d’ajuda">'
          ...
          + '<li><a href="#help-actualizaciones">Actualitzacions</a></li>'
          ...
          + '<li>Tria una ruta: <strong>Crear un ZIP</strong> o <strong>Ja tinc un ZIP al núvol amb enllaç</strong>.</li>'
          ...
          + '</ol>'
          + '<h4 class="about-subtitle" id="help-ruta-tengo" tabindex="-1">Ruta: Ja tinc un ZIP al núvol amb enllaç</h4>'
          + '<ol class="about-steps">'
          + '<li>A <strong>Publicar</strong>, entra a <strong>Ja tinc un ZIP al núvol amb enllaç</strong>.</li>'
          ...
          + '<li><strong>QR</strong>: mostra un codi QR de l’enllaç (ideal per projectar o imprimir).</li>'
          + '<li><strong>Inserir en web</strong>: mostra el codi per incrustar-lo (si està permès).</li>'
          + '<li><strong>Actualitzar</strong>: torna a descarregar el ZIP i actualitza la còpia local (si el recurs ha canviat mantenint el mateix enllaç).</li>'
          ...
          + '</ul>'
          + '<p class="about-note">Nota: si esborres les dades del navegador, fas servir un altre dispositiu o un navegador diferent, aquests desapareixeran.</p>'
          + '</section>'
          + '<section aria-labelledby="help-actualizaciones">'
          + '<h3 class="about-section-title" id="help-actualizaciones" tabindex="-1">Actualitzacions</h3>'
          + '<p>El visor pot detectar canvis en un recurs quan el fitxer ZIP es substitueix al núvol <strong>mantenint el mateix enllaç</strong>. En la majoria de serveis d’emmagatzematge n’hi ha prou amb <strong>pujar el nou ZIP reemplaçant l’anterior</strong>.</p>'
          + '<ul>'
          + '<li><strong>A la vista de l’alumnat</strong>, si el recurs ha canviat, apareix un avís visible que permet <strong>actualitzar-lo en aquell mateix moment</strong>.</li>'
          + '<li>Al <strong>Gestor</strong>, utilitza <strong>Comprovar actualitzacions</strong> per revisar tots els recursos desats.</li>'
          + '<li>Quan es detecten canvis, apareix l’etiqueta <strong>«Actualització disponible»</strong> al costat del recurs.</li>'
          + '<li>En prémer <strong>Actualitzar</strong>, es descarrega i s’utilitza la versió nova del ZIP.</li>'
          + '<li>Després d’actualitzar, es mostra una etiqueta verda amb la <strong>data de l’última actualització</strong>.</li>'
          + '</ul>'
          + '</section>'
          + '<section aria-labelledby="help-limitaciones">'
    ...
    gl: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Índice de axuda">'
          ...
          + '<li><a href="#help-actualizaciones">Actualizacións</a></li>'
          ...
          + '<li>Escolle unha ruta: <strong>Crear un ZIP</strong> ou <strong>Xa teño un ZIP na nube con ligazón</strong>.</li>'
          ...
          + '</ol>'
          + '<h4 class="about-subtitle" id="help-ruta-tengo" tabindex="-1">Ruta: Xa teño un ZIP na nube con ligazón</h4>'
          + '<ol class="about-steps">'
          + '<li>En <strong>Publicar</strong>, entra en <strong>Xa teño un ZIP na nube con ligazón</strong>.</li>'
          ...
          + '<li><strong>QR</strong>: amosa un código QR da ligazón (ideal para proxectar ou imprimir).</li>'
          + '<li><strong>Inserir nunha web</strong>: amosa o código para incrustalo (se está permitido).</li>'
          + '<li><strong>Actualizar</strong>: volve descargar o ZIP e actualiza a copia local (se o recurso cambiou mantendo a mesma ligazón).</li>'
          ...
          + '</ul>'
          + '<p class="about-note">Nota: se borras os datos do navegador, usas outro dispositivo ou un navegador distinto, estes desaparecerán.</p>'
          + '</section>'
          + '<section aria-labelledby="help-actualizaciones">'
          + '<h3 class="about-section-title" id="help-actualizaciones" tabindex="-1">Actualizacións</h3>'
          + '<p>O visor pode detectar cambios nun recurso cando o ZIP se substitúe na nube <strong>mantendo a mesma ligazón</strong>. Na maioría dos servizos de almacenamento chega con <strong>subir o novo ZIP substituíndo o anterior</strong>.</p>'
          + '<ul>'
          + '<li><strong>Na vista do alumnado</strong>, se o recurso cambiou, aparece un aviso visible que permite <strong>actualizalo nese mesmo momento</strong>.</li>'
          + '<li>No <strong>Gestor</strong>, usa <strong>Comprobar actualizacións</strong> para revisar todos os recursos gardados.</li>'
          + '<li>Cando se detectan cambios, aparece a etiqueta <strong>«Actualización dispoñible»</strong> xunto ao recurso.</li>'
          + '<li>Ao premer <strong>Actualizar</strong>, descárgase e úsase a versión nova do ZIP.</li>'
          + '<li>Despois de actualizar, móstrase unha etiqueta verde coa <strong>data da última actualización</strong>.</li>'
          + '</ul>'
          + '</section>'
          + '<section aria-labelledby="help-limitaciones">'
    ...
    eu: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Laguntzaren aurkibidea">'
          ...
          + '<li><a href="#help-actualizaciones">Eguneratzeak</a></li>'
          ...
          + '<li>Aukeratu ibilbidea: <strong>ZIPa sortu</strong> edo <strong>ZIP bat hodeian daukat estekarekin</strong>.</li>'
          ...
          + '</ol>'
          + '<h4 class="about-subtitle" id="help-ruta-tengo" tabindex="-1">Ibilbidea: ZIP bat hodeian daukat estekarekin</h4>'
          + '<ol class="about-steps">'
          + '<li><strong>Argitaratu</strong> atalean, sartu <strong>ZIP bat hodeian daukat estekarekin</strong> aukeran.</li>'
          ...
          + '<li><strong>QR</strong>: estekaren QR kodea erakusten du (proiektatzeko edo inprimatzeko egokia).</li>'
          + '<li><strong>Web batean txertatu</strong>: txertatzeko kodea erakusten du (baimenduta badago).</li>'
          + '<li><strong>Eguneratu</strong>: ZIPa berriro deskargatzen du eta kopia lokala eguneratzen du (baliabidea esteka bera mantenduta aldatu bada).</li>'
          ...
          + '</ul>'
          + '<p class="about-note">Oharra: nabigatzaileko datuak ezabatzen badituzu, beste gailu bat erabiltzen baduzu edo beste nabigatzaile bat, baliabide hauek desagertuko dira.</p>'
          + '</section>'
          + '<section aria-labelledby="help-actualizaciones">'
          + '<h3 class="about-section-title" id="help-actualizaciones" tabindex="-1">Eguneratzeak</h3>'
          + '<p>Bisoreak baliabide batean egindako aldaketak hauteman ditzake ZIP fitxategia hodeian ordezkatzen denean, <strong>esteka bera mantenduz</strong>. Biltegiratze zerbitzu gehienetan nahikoa da <strong>ZIP berria igo eta aurrekoa ordezkatzea</strong>.</p>'
          + '<ul>'
          + '<li><strong>Ikaslearen ikuspegian</strong>, baliabidea aldatu bada, abisu ikusgarri bat agertzen da eta <strong>une horretan bertan eguneratzeko</strong> aukera ematen du.</li>'
          + '<li><strong>Kudeatzailean</strong>, erabili <strong>Eguneratzeak egiaztatu</strong> gordetako baliabide guztiak berrikusteko.</li>'
          + '<li>Aldaketak atzematen direnean, <strong>«Eguneraketa eskuragarri»</strong> etiketa agertzen da baliabidearen ondoan.</li>'
          + '<li><strong>Eguneratu</strong> sakatzean, ZIParen bertsio berria deskargatu eta erabiltzen da.</li>'
          + '<li>Eguneratu ondoren, etiketa berde bat agertzen da <strong>azken eguneraketaren datarekin</strong>.</li>'
          + '</ul>'
          + '</section>'
          + '<section aria-labelledby="help-limitaciones">'
    ...
    en: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Help index">'
          ...
          + '<li><a href="#help-actualizaciones">Updates</a></li>'
          ...
          + '<li>Choose a path: <strong>Create a ZIP</strong> or <strong>I already have a ZIP in the cloud with link</strong>.</li>'
          ...
          + '</ol>'
          + '<h4 class="about-subtitle" id="help-ruta-tengo" tabindex="-1">Path: I already have a ZIP in the cloud with link</h4>'
          + '<ol class="about-steps">'
          + '<li>In <strong>Publish</strong>, open <strong>I already have a ZIP in the cloud with link</strong>.</li>'
          ...
          + '<li><strong>QR</strong>: shows a QR code for the link (great for projecting or printing).</li>'
          + '<li><strong>Embed</strong>: shows the embed code (if allowed).</li>'
          + '<li><strong>Update</strong>: downloads the ZIP again and updates the local copy (if the resource changed while keeping the same link).</li>'
          ...
          + '</ul>'
          + '<p class="about-note">Note: if you clear browser storage, switch devices, or use a different browser, these resources will disappear.</p>'
          + '</section>'
          + '<section aria-labelledby="help-actualizaciones">'
          + '<h3 class="about-section-title" id="help-actualizaciones" tabindex="-1">Updates</h3>'
          + '<p>The viewer can detect changes when the ZIP is replaced in the cloud <strong>while keeping the same link</strong>. In most storage services, it’s enough to <strong>upload the new ZIP replacing the old one</strong>.</p>'
          + '<ul>'
          + '<li><strong>In the student view</strong>, if the resource has changed, a visible notice appears and lets you <strong>update it right away</strong>.</li>'
          + '<li>In the <strong>Manager</strong>, use <strong>Check updates</strong> to review all saved resources.</li>'
          + '<li>When changes are detected, the <strong>“Update available”</strong> label appears next to the resource.</li>'
          + '<li>Click <strong>Update</strong> to download and use the new ZIP version.</li>'
          + '<li>After updating, a green label shows the <strong>date of the last update</strong>.</li>'
          + '</ul>'
          + '</section>'
          + '<section aria-labelledby="help-limitaciones">'
    ...
    de: {
      ...
      about: {
        ...
        body: '<nav class="about-index" data-help-nav aria-label="Hilfe-Inhalt">'
          ...
          + '<li>Wähle einen Pfad: <strong>ZIP erstellen</strong> oder <strong>Ich habe bereits eine ZIP-Datei in der Cloud mit Link</strong>.</li>'
          ...
          + '</ol>'
          + '<h4 class="about-subtitle" id="help-ruta-tengo" tabindex="-1">Pfad: Ich habe bereits eine ZIP-Datei in der Cloud mit Link</h4>'
          + '<ol class="about-steps">'
          + '<li>Unter <strong>Veröffentlichen</strong> wähle <strong>Ich habe bereits eine ZIP-Datei in der Cloud mit Link</strong>.</li>'
          ...
          + '<li><strong>QR</strong>: zeigt einen QR-Code für den Link (ideal zum Projizieren oder Drucken).</li>'
          + '<li><strong>Einbetten</strong>: zeigt den Einbett-Code (falls erlaubt).</li>'
          + '<li><strong>Aktualisieren</strong>: lädt die ZIP erneut herunter und aktualisiert die lokale Kopie (wenn sich die Ressource geändert hat, ohne dass sich der Link ändert).</li>'
          ...
          + '</ul>'
          + '<p class="about-note">Hinweis: Wenn du Browserdaten löschst, das Gerät wechselst oder einen anderen Browser nutzt, verschwinden diese Ressourcen.</p>'
          + '</section>'
          + '<section aria-labelledby="help-actualizaciones">'
          + '<h3 class="about-section-title" id="help-actualizaciones" tabindex="-1">Updates</h3>'
          + '<p>Der Viewer kann Änderungen erkennen, wenn die ZIP in der Cloud ersetzt wird und <strong>der gleiche Link</strong> erhalten bleibt. In den meisten Speicher-Diensten reicht es, <strong>die neue ZIP hochzuladen und die alte zu ersetzen</strong>.</p>'
          + '<ul>'
          + '<li><strong>In der Schüleransicht</strong> erscheint bei Änderungen ein sichtbarer Hinweis, der das <strong>sofortige Aktualisieren</strong> ermöglicht.</li>'
          + '<li>Im <strong>Manager</strong> nutze <strong>Updates prüfen</strong>, um alle gespeicherten Ressourcen zu überprüfen.</li>'
          + '<li>Wenn Änderungen erkannt werden, erscheint das Label <strong>„Update verfügbar“</strong> neben der Ressource.</li>'
          + '<li>Mit <strong>Aktualisieren</strong> wird die neue ZIP-Version heruntergeladen und verwendet.</li>'
          + '<li>Nach dem Update wird ein grünes Label mit dem <strong>Datum der letzten Aktualisierung</strong> angezeigt.</li>'
          + '</ul>'
          + '</section>'
          + '<section aria-labelledby="help-limitaciones">'
